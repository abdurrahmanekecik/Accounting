...
$manager_control = $db-> prepare("SELECT * FROM managers WHERE manager_name=:name");
$manager_control -> execute(['name' => $_SESSION['manager_name']]);

$managercontrol=$manager_control->rowCount();
$manager_true_control=$manager_control->fetch(PDO::FETCH_ASSOC);
    if ($managercontrol==0) {
