        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php if ($total_revenues > 0) { echo $total_revenues; } else { echo "0";} ?></h3>
                <p>Montly Revenues</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                 <h3><?php  if ($total_expenses > 0) { echo $total_expenses; } else { echo "0";} ?></h3>        
               <p>Montly Expenses</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                 ...
                 <h3><?php if ($total_customer > 0) { echo $total_customer; } else { echo "0";} ?></h3>
