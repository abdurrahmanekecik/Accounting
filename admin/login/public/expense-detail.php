...
$expense_detail_setting -> execute([ 
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            'customer_id'=> $expense_detail_take['customer_id']]);
        ...
        <input type="hidden" name="expense_id" value="<?php echo $expense_detail_take['expense_id'] ?>"> 
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" name="expense_despriction" class="form-control" value="<?php echo $expense_detail_take['expense_despriction'];?>" placeholder="Expense_id">
                  </div>
                  <div class="form-group">
                  <label>Expense Date</label>
                    <div class="input-group date">
                        <input name="expense_date" value="<?php echo $expense_detail_take['expense_date'];?>" type="date" class="form-control datetimepicker-input" />
                  ...
                  <option value="1" <?php echo $expense_detail_take['expense_situation'] == '1' ? 'selected=""' : ''; ?>>Active</option>
                  <option value="0" <?php if ($expense_detail_take['expense_situation']==0) {  'selected=""'; } ?>>Passive</option>
              </select>
               </div>
